        ...
        <div class="content-inner">
          ...
          <header class="page-header">
            ...
            <li><a href="<?php echo site_url('admin/c_admin/menu_admin');?>">หน้าหลัก</a></li>
                ...
                <li><?php echo "รายชื่อนิสิตสาขา".$branch." รหัส ".$Entry_Years." ที่รับเข้าศึกษาโดย".$Entry_Method ?></li>
        ...
        <div class="col-sm-12">
          <div class="card">
            <div class="card-header">
              ...
              <h1><strong><center><?php echo "รายชื่อนิสิตสาขา".$branch." รหัส ".$Entry_Years." ที่รับเข้าศึกษาโดย".$Entry_Method ?></strong></h1>
            </div>
            <div class="card-body">
