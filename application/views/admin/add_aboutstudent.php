        ...
        <div class="col-sm-12"><br>
          <div class="card">
            <div class="card-header">
              <h1><strong><center>เพิ่มข้อมูลนิสิต (ข้อมูลวิทยาการสารสนเทศ)</strong></h1>
            </div>
                ...
                <div class="col-md-12 form-group" ><br>
                  <div class="form-group row">
                    <label class="col-md-12 col-form-label" for="text-input">เลือกไฟล์</label>
                      ...
                      <a href = "https://docs.google.com/document/d/13tUN3Zsv3KBcC3KcfKOO4R9g0WNComAIUrhciROxYGk/">คู่มือการอัพโหลด</a>
