...
class M_student extends CI_Model
{
        ...
        public function get_status_10($years) {
            //$arr = [10,11,12,40,45,50,51,52,53,60,61,62,63,64,65,68,69,80,81,82,83,90];
            $arrlevel = ['ปริญญาตรี ปกติ','ปริญญาตรี พิเศษ','ปริญญาโท ปกติ','ปริญญาโท พิเศษ','ปริญญาเอก ปกติ'];
            
            for($i = 0;$i<count($arrlevel);$i++) {
                //$wherestatus = " Status.Status_ID='".$arr[$i]."'";
                $wherelevel = " Level='".$arrlevel[$i]."'";
            $sql = "SELECT Status.Status_ID,Status.Status_Name, Level, count(*) AS Count 
            FROM Student 
            LEFT JOIN Status ON Student.Status_ID = Status.Status_ID 
            WHERE Status.Status_ID=10 AND (Entry_Years = '".$years."') AND $wherelevel
        ...
        public function get_status_10_aa($years,$course) {
            ...
            if(strlen($years) != 4) {
                ...
                foreach ($levels as $key => $level):
                    ...
                    LEFT JOIN Status ON Student.Status_ID = Status.Status_ID 
                    INNER JOIN Course ON SUBSTRING_INDEX(Student.Course,':',1) = SUBSTRING_INDEX(Course.Course_Name,':',1)
                    WHERE Status.Status_ID=10 AND Entry_Years = '$attribute' AND Level = '$level' ";
                    if($course != '') {
                        $sql .= "AND (Course.Course_ID = '$course') ";
                    }
                    $sql.= " GROUP BY Status_Name,Level";
        ...
        public function get_status_11_aa($years,$course) {
            ...
            if(strlen($years) != 4) {
                ...
                foreach ($levels as $key => $level):
                    ...
                    FROM Student 
                    LEFT JOIN Status ON Student.Status_ID = Status.Status_ID 
                    WHERE Status.Status_ID=11 AND Entry_Years = '$attribute' AND Level = '$level'
                    GROUP BY Status_Name,Level";
                    $query = $this->db->query($sql);
            ...
            return $q;
                ...
                FROM Student 
                LEFT JOIN Status ON Student.Status_ID = Status.Status_ID 
                WHERE Status.Status_ID=11 AND Entry_Years = '$years' AND $wherelevel
                GROUP BY Status_Name,Level";
                $query = $this->db->query($sql);
        ...
        public function get_status_40_aa($years,$course) {
            ...
            if(strlen($years) != 4) {
                ...
                foreach ($levels as $key => $level):
                    ...
                    FROM Student 
                    LEFT JOIN Status ON Student.Status_ID = Status.Status_ID 
                    WHERE Status.Status_ID=40 AND Entry_Years = '$attribute' AND Level = '$level'
                    GROUP BY Status_Name,Level";
                    $query = $this->db->query($sql);
            ...
            return $q;
                ...
                FROM Student 
                LEFT JOIN Status ON Student.Status_ID = Status.Status_ID 
                WHERE Status.Status_ID=40 AND Entry_Years = '$years' AND $wherelevel
                GROUP BY Status_Name,Level";
                $query = $this->db->query($sql);
        ...
        public function get_status_12_aa($years,$course) {
            ...
            if(strlen($years) != 4) {
                ...
                foreach ($levels as $key => $level):
                    ...
                    FROM Student 
                    LEFT JOIN Status ON Student.Status_ID = Status.Status_ID 
                    WHERE Status.Status_ID=12 AND Entry_Years = '$attribute' AND Level = '$level'
                    GROUP BY Status_Name,Level";
                    $query = $this->db->query($sql);
            ...
            return $q;
                ...
                FROM Student 
                LEFT JOIN Status ON Student.Status_ID = Status.Status_ID 
                WHERE Status.Status_ID=12 AND Entry_Years = '$years' AND $wherelevel
                GROUP BY Status_Name,Level";
                $query = $this->db->query($sql);
        ...
        public function get_status_45_aa($years,$course) {
            ...
            if(strlen($years) != 4) {
                ...
                foreach ($levels as $key => $level):
                    ...
                    FROM Student 
                    LEFT JOIN Status ON Student.Status_ID = Status.Status_ID 
                    WHERE Status.Status_ID=45 AND Entry_Years = '$attribute' AND Level = '$level'
                    GROUP BY Status_Name,Level";
                    $query = $this->db->query($sql);
            ...
            return $q;
                ...
                FROM Student 
                LEFT JOIN Status ON Student.Status_ID = Status.Status_ID 
                WHERE Status.Status_ID=45 AND Entry_Years = '$years' AND $wherelevel
                GROUP BY Status_Name,Level";
                $query = $this->db->query($sql);
        ...
        public function get_status_50_aa($years,$course) {
            ...
            if(strlen($years) != 4) {
                ...
                foreach ($levels as $key => $level):
                    ...
                    FROM Student 
                    LEFT JOIN Status ON Student.Status_ID = Status.Status_ID 
                    WHERE Status.Status_ID=50 AND Entry_Years = '$attribute' AND Level = '$level'
                    GROUP BY Status_Name,Level";
                    $query = $this->db->query($sql);
            ...
            return $q;
                ...
                FROM Student 
                LEFT JOIN Status ON Student.Status_ID = Status.Status_ID 
                WHERE Status.Status_ID=50 AND Entry_Years = '$years' AND $wherelevel
                GROUP BY Status_Name,Level";
                $query = $this->db->query($sql);
        ...
        public function get_status_51_aa($years,$course) {
            ...
            if(strlen($years) != 4) {
                ...
                foreach ($levels as $key => $level):
                    ...
                    FROM Student 
                    LEFT JOIN Status ON Student.Status_ID = Status.Status_ID 
                    WHERE Status.Status_ID=51 AND Entry_Years = '$attribute' AND Level = '$level'
                    GROUP BY Status_Name,Level";
                    $query = $this->db->query($sql);
            ...
            return $q;
                ...
                FROM Student 
                LEFT JOIN Status ON Student.Status_ID = Status.Status_ID 
                WHERE Status.Status_ID=51 AND Entry_Years = '$years' AND $wherelevel
                GROUP BY Status_Name,Level";
                $query = $this->db->query($sql);
        ...
        public function get_status_52_aa($years,$course) {
            ...
            if(strlen($years) != 4) {
                ...
                foreach ($levels as $key => $level):
                    ...
                    FROM Student 
                    LEFT JOIN Status ON Student.Status_ID = Status.Status_ID 
                    WHERE Status.Status_ID=52 AND Entry_Years = '$attribute' AND Level = '$level'
                    GROUP BY Status_Name,Level";
                    $query = $this->db->query($sql);
            ...
            return $q;
                ...
                FROM Student 
                LEFT JOIN Status ON Student.Status_ID = Status.Status_ID 
                WHERE Status.Status_ID=52 AND Entry_Years = '$years' AND $wherelevel
                GROUP BY Status_Name,Level";
                $query = $this->db->query($sql);
        ...
        public function get_status_53_aa($years,$course) {
            ...
            if(strlen($years) != 4) {
                ...
                foreach ($levels as $key => $level):
                    ...
                    FROM Student 
                    LEFT JOIN Status ON Student.Status_ID = Status.Status_ID 
                    WHERE Status.Status_ID=53 AND Entry_Years = '$attribute' AND Level = '$level'
                    GROUP BY Status_Name,Level";
                    $query = $this->db->query($sql);
            ...
            return $q;
                ...
                FROM Student 
                LEFT JOIN Status ON Student.Status_ID = Status.Status_ID 
                WHERE Status.Status_ID=53 AND Entry_Years = '$years' AND $wherelevel
                GROUP BY Status_Name,Level";
                $query = $this->db->query($sql);
        ...
        public function get_status_60_aa($years,$course) {
            ...
            if(strlen($years) != 4) {
                ...
                foreach ($levels as $key => $level):
                    ...
                    FROM Student 
                    LEFT JOIN Status ON Student.Status_ID = Status.Status_ID 
                    WHERE Status.Status_ID=60 AND Entry_Years = '$attribute' AND Level = '$level'
                    GROUP BY Status_Name,Level";
                    $query = $this->db->query($sql);
            ...
            return $q;
                ...
                FROM Student 
                LEFT JOIN Status ON Student.Status_ID = Status.Status_ID 
                WHERE Status.Status_ID=60 AND Entry_Years = '$years' AND $wherelevel
                GROUP BY Status_Name,Level";
                $query = $this->db->query($sql);
        ...
        public function get_status_61_aa($years,$course) {
            ...
            if(strlen($years) != 4) {
                ...
                foreach ($levels as $key => $level):
                    ...
                    FROM Student 
                    LEFT JOIN Status ON Student.Status_ID = Status.Status_ID 
                    WHERE Status.Status_ID=61 AND Entry_Years = '$attribute' AND Level = '$level'
                    GROUP BY Status_Name,Level";
                    $query = $this->db->query($sql);
            ...
            return $q;
                ...
                FROM Student 
                LEFT JOIN Status ON Student.Status_ID = Status.Status_ID 
                WHERE Status.Status_ID=61 AND Entry_Years = '$years' AND $wherelevel
                GROUP BY Status_Name,Level";
                $query = $this->db->query($sql);
        ...
        public function get_status_62_aa($years,$course) {
            ...
            if(strlen($years) != 4) {
                ...
                foreach ($levels as $key => $level):
                    ...
                    FROM Student 
                    LEFT JOIN Status ON Student.Status_ID = Status.Status_ID 
                    WHERE Status.Status_ID=62 AND Entry_Years = '$attribute' AND Level = '$level'
                    GROUP BY Status_Name,Level";
                    $query = $this->db->query($sql);
            ...
            return $q;
                ...
                FROM Student 
                LEFT JOIN Status ON Student.Status_ID = Status.Status_ID 
                WHERE Status.Status_ID=62 AND Entry_Years = '$years' AND $wherelevel
                GROUP BY Status_Name,Level";
                $query = $this->db->query($sql);
        ...
        public function get_status_63_aa($years,$course) {
            ...
            if(strlen($years) != 4) {
                ...
                foreach ($levels as $key => $level):
                    ...
                    FROM Student 
                    LEFT JOIN Status ON Student.Status_ID = Status.Status_ID 
                    WHERE Status.Status_ID=63 AND Entry_Years = '$attribute' AND Level = '$level'
                    GROUP BY Status_Name,Level";
                    $query = $this->db->query($sql);
            ...
            return $q;
                ...
                FROM Student 
                LEFT JOIN Status ON Student.Status_ID = Status.Status_ID 
                WHERE Status.Status_ID=63 AND Entry_Years = '$years' AND $wherelevel
                GROUP BY Status_Name,Level";
                $query = $this->db->query($sql);
        ...
        public function get_status_64_aa($years,$course) {
            ...
            if(strlen($years) != 4) {
                ...
                foreach ($levels as $key => $level):
                    ...
                    FROM Student 
                    LEFT JOIN Status ON Student.Status_ID = Status.Status_ID 
                    WHERE Status.Status_ID=64 AND Entry_Years = '$attribute' AND Level = '$level'
                    GROUP BY Status_Name,Level";
                    $query = $this->db->query($sql);
            ...
            return $q;
                ...
                FROM Student 
                LEFT JOIN Status ON Student.Status_ID = Status.Status_ID 
                WHERE Status.Status_ID=64 AND Entry_Years = '$years' AND $wherelevel
                GROUP BY Status_Name,Level";
                $query = $this->db->query($sql);
        ...
        public function get_status_65_aa($years,$course) {
            ...
            if(strlen($years) != 4) {
                ...
                foreach ($levels as $key => $level):
                    ...
                    FROM Student 
                    LEFT JOIN Status ON Student.Status_ID = Status.Status_ID 
                    WHERE Status.Status_ID=65 AND Entry_Years = '$attribute' AND Level = '$level'
                    GROUP BY Status_Name,Level";
                    $query = $this->db->query($sql);
            ...
            return $q;
                ...
                FROM Student 
                LEFT JOIN Status ON Student.Status_ID = Status.Status_ID 
                WHERE Status.Status_ID=65 AND Entry_Years = '$years' AND $wherelevel
                GROUP BY Status_Name,Level";
                $query = $this->db->query($sql);
        ...
        public function get_status_11($years) {
            //$arr = [10,11,12,40,45,50,51,52,53,60,61,62,63,64,65,68,69,80,81,82,83,90];
            $arrlevel = ['ปริญญาตรี ปกติ','ปริญญาตรี พิเศษ','ปริญญาโท ปกติ','ปริญญาโท พิเศษ','ปริญญาเอก ปกติ'];
        ...
        public function get_status_68_aa($years,$course) {
            ...
            if(strlen($years) != 4) {
                ...
                foreach ($levels as $key => $level):
                    ...
                    FROM Student 
                    LEFT JOIN Status ON Student.Status_ID = Status.Status_ID 
                    WHERE Status.Status_ID=68 AND Entry_Years = '$attribute' AND Level = '$level'
                    GROUP BY Status_Name,Level";
                    $query = $this->db->query($sql);
            ...
            return $q;
                ...
                FROM Student 
                LEFT JOIN Status ON Student.Status_ID = Status.Status_ID 
                WHERE Status.Status_ID=68 AND Entry_Years = '$years' AND $wherelevel
                GROUP BY Status_Name,Level";
                $query = $this->db->query($sql);
        ...
        public function get_status_69_aa($years,$course) {
            ...
            if(strlen($years) != 4) {
                ...
                foreach ($levels as $key => $level):
                    ...
                    FROM Student 
                    LEFT JOIN Status ON Student.Status_ID = Status.Status_ID 
                    WHERE Status.Status_ID=69 AND Entry_Years = '$attribute' AND Level = '$level'
                    GROUP BY Status_Name,Level";
                    $query = $this->db->query($sql);
            ...
            return $q;
                ...
                FROM Student 
                LEFT JOIN Status ON Student.Status_ID = Status.Status_ID 
                WHERE Status.Status_ID=69 AND Entry_Years = '$years' AND $wherelevel
                GROUP BY Status_Name,Level";
                $query = $this->db->query($sql);
        ...
        public function get_status_80_aa($years,$course) {
            ...
            if(strlen($years) != 4) {
                ...
                foreach ($levels as $key => $level):
                    ...
                    FROM Student 
                    LEFT JOIN Status ON Student.Status_ID = Status.Status_ID 
                    WHERE Status.Status_ID=80 AND Entry_Years = '$attribute' AND Level = '$level'
                    GROUP BY Status_Name,Level";
                    $query = $this->db->query($sql);
            ...
            return $q;
                ...
                FROM Student 
                LEFT JOIN Status ON Student.Status_ID = Status.Status_ID 
                WHERE Status.Status_ID=80 AND Entry_Years = '$years' AND $wherelevel
                GROUP BY Status_Name,Level";
                $query = $this->db->query($sql);
        ...
        public function get_status_81_aa($years,$course) {
            ...
            if(strlen($years) != 4) {
                ...
                foreach ($levels as $key => $level):
                    ...
                    FROM Student 
                    LEFT JOIN Status ON Student.Status_ID = Status.Status_ID 
                    WHERE Status.Status_ID=81 AND Entry_Years = '$attribute' AND Level = '$level'
                    GROUP BY Status_Name,Level";
                    $query = $this->db->query($sql);
            ...
            return $q;
                ...
                FROM Student 
                LEFT JOIN Status ON Student.Status_ID = Status.Status_ID 
                WHERE Status.Status_ID=81 AND Entry_Years = '$years' AND $wherelevel
                GROUP BY Status_Name,Level";
                $query = $this->db->query($sql);
        ...
        public function get_status_82_aa($years,$course) {
            ...
            if(strlen($years) != 4) {
                ...
                foreach ($levels as $key => $level):
                    ...
                    FROM Student 
                    LEFT JOIN Status ON Student.Status_ID = Status.Status_ID 
                    WHERE Status.Status_ID=82 AND Entry_Years = '$attribute' AND Level = '$level'
                    GROUP BY Status_Name,Level";
                    $query = $this->db->query($sql);
            ...
            return $q;
                ...
                FROM Student 
                LEFT JOIN Status ON Student.Status_ID = Status.Status_ID 
                WHERE Status.Status_ID=82 AND Entry_Years = '$years' AND $wherelevel
                GROUP BY Status_Name,Level";
                $query = $this->db->query($sql);
        ...
        public function get_status_83_aa($years,$course) {
            ...
            if(strlen($years) != 4) {
                ...
                foreach ($levels as $key => $level):
                    ...
                    FROM Student 
                    LEFT JOIN Status ON Student.Status_ID = Status.Status_ID 
                    WHERE Status.Status_ID=83 AND Entry_Years = '$attribute' AND Level = '$level'
                    GROUP BY Status_Name,Level";
                    $query = $this->db->query($sql);
            ...
            return $q;
                ...
                FROM Student 
                LEFT JOIN Status ON Student.Status_ID = Status.Status_ID 
                WHERE Status.Status_ID=83 AND Entry_Years = '$years' AND $wherelevel
                GROUP BY Status_Name,Level";
                $query = $this->db->query($sql);
        ...
        public function get_status_90_aa($years,$course) {
            ...
            if(strlen($years) != 4) {
                ...
                foreach ($levels as $key => $level):
                    ...
                    FROM Student 
                    LEFT JOIN Status ON Student.Status_ID = Status.Status_ID 
                    WHERE Status.Status_ID=90 AND Entry_Years = '$attribute' AND Level = '$level'
                    GROUP BY Status_Name,Level";
                    $query = $this->db->query($sql);
            ...
            return $q;
                ...
                FROM Student 
                LEFT JOIN Status ON Student.Status_ID = Status.Status_ID 
                WHERE Status.Status_ID=90 AND Entry_Years = '$years' AND $wherelevel
                GROUP BY Status_Name,Level";
                $query = $this->db->query($sql);
        ...
        public function get_status_12($years,$course) {
            //$arr = [10,11,12,40,45,50,51,52,53,60,61,62,63,64,65,68,69,80,81,82,83,90];
            $arrlevel = ['ปริญญาตรี ปกติ','ปริญญาตรี พิเศษ','ปริญญาโท ปกติ','ปริญญาโท พิเศษ','ปริญญาเอก ปกติ'];
        ...
        public function get_status_40($years,$course) {
            //$arr = [10,11,12,40,45,50,51,52,53,60,61,62,63,64,65,68,69,80,81,82,83,90];
            $arrlevel = ['ปริญญาตรี ปกติ','ปริญญาตรี พิเศษ','ปริญญาโท ปกติ','ปริญญาโท พิเศษ','ปริญญาเอก ปกติ'];
        ...
        public function get_status_45($years,$course) {
            //$arr = [10,11,12,40,45,50,51,52,53,60,61,62,63,64,65,68,69,80,81,82,83,90];
            $arrlevel = ['ปริญญาตรี ปกติ','ปริญญาตรี พิเศษ','ปริญญาโท ปกติ','ปริญญาโท พิเศษ','ปริญญาเอก ปกติ'];
        ...
        public function get_status_50($years) {
            //$arr = [10,11,12,40,45,50,51,52,53,60,61,62,63,64,65,68,69,80,81,82,83,90];
            $arrlevel = ['ปริญญาตรี ปกติ','ปริญญาตรี พิเศษ','ปริญญาโท ปกติ','ปริญญาโท พิเศษ','ปริญญาเอก ปกติ'];
            ...
            if ($query->num_rows() ==0) {
                ...
                $q[$i][0] = new stdClass;
                $q[$i][0]->Status_ID = '50';
                $q[$i][0]->Status_Name = "ลาออก";
                $q[$i][0]->Level = $arrlevel[$i];
                $q[$i][0]->Count = "-";
        ...
        public function get_status_51($years) {
            //$arr = [10,11,12,40,45,50,51,52,53,60,61,62,63,64,65,68,69,80,81,82,83,90];
            $arrlevel = ['ปริญญาตรี ปกติ','ปริญญาตรี พิเศษ','ปริญญาโท ปกติ','ปริญญาโท พิเศษ','ปริญญาเอก ปกติ'];
        ...
        public function get_status_52($years) {
            //$arr = [10,11,12,40,45,50,51,52,53,60,61,62,63,64,65,68,69,80,81,82,83,90];
            $arrlevel = ['ปริญญาตรี ปกติ','ปริญญาตรี พิเศษ','ปริญญาโท ปกติ','ปริญญาโท พิเศษ','ปริญญาเอก ปกติ'];
        ...
        public function get_status_53($years) {
            //$arr = [10,11,12,40,45,50,51,52,53,60,61,62,63,64,65,68,69,80,81,82,83,90];
            $arrlevel = ['ปริญญาตรี ปกติ','ปริญญาตรี พิเศษ','ปริญญาโท ปกติ','ปริญญาโท พิเศษ','ปริญญาเอก ปกติ'];
        ...
        public function get_status_60($years) {
            //$arr = [10,11,12,40,45,50,51,52,53,60,61,62,63,64,65,68,69,80,81,82,83,90];
            $arrlevel = ['ปริญญาตรี ปกติ','ปริญญาตรี พิเศษ','ปริญญาโท ปกติ','ปริญญาโท พิเศษ','ปริญญาเอก ปกติ'];
        ...
        public function get_status_61($years) {
            //$arr = [10,11,12,40,45,50,51,52,53,60,61,62,63,64,65,68,69,80,81,82,83,90];
            $arrlevel = ['ปริญญาตรี ปกติ','ปริญญาตรี พิเศษ','ปริญญาโท ปกติ','ปริญญาโท พิเศษ','ปริญญาเอก ปกติ'];
        ...
        public function get_status_62($years) {
            //$arr = [10,11,12,40,45,50,51,52,53,60,61,62,63,64,65,68,69,80,81,82,83,90];
            $arrlevel = ['ปริญญาตรี ปกติ','ปริญญาตรี พิเศษ','ปริญญาโท ปกติ','ปริญญาโท พิเศษ','ปริญญาเอก ปกติ'];
        ...
        public function get_status_63($years) {
            //$arr = [10,11,12,40,45,50,51,52,53,60,61,62,63,64,65,68,69,80,81,82,83,90];
            $arrlevel = ['ปริญญาตรี ปกติ','ปริญญาตรี พิเศษ','ปริญญาโท ปกติ','ปริญญาโท พิเศษ','ปริญญาเอก ปกติ'];
        ...
        public function get_status_64($years) {
            //$arr = [10,11,12,40,45,50,51,52,53,60,61,62,63,64,65,68,69,80,81,82,83,90];
            $arrlevel = ['ปริญญาตรี ปกติ','ปริญญาตรี พิเศษ','ปริญญาโท ปกติ','ปริญญาโท พิเศษ','ปริญญาเอก ปกติ'];
        ...
        public function get_status_65($years) {
            //$arr = [10,11,12,40,45,50,51,52,53,60,61,62,63,64,65,68,69,80,81,82,83,90];
            $arrlevel = ['ปริญญาตรี ปกติ','ปริญญาตรี พิเศษ','ปริญญาโท ปกติ','ปริญญาโท พิเศษ','ปริญญาเอก ปกติ'];
        ...
        public function get_status_68($years) {
            //$arr = [10,11,12,40,45,50,51,52,53,60,61,62,63,64,65,68,69,80,81,82,83,90];
            $arrlevel = ['ปริญญาตรี ปกติ','ปริญญาตรี พิเศษ','ปริญญาโท ปกติ','ปริญญาโท พิเศษ','ปริญญาเอก ปกติ'];
        ...
        public function get_status_69($years) {
            //$arr = [10,11,12,40,45,50,51,52,53,60,61,62,63,64,65,68,69,80,81,82,83,90];
            $arrlevel = ['ปริญญาตรี ปกติ','ปริญญาตรี พิเศษ','ปริญญาโท ปกติ','ปริญญาโท พิเศษ','ปริญญาเอก ปกติ'];
        ...
        public function get_status_80($years) {
            //$arr = [10,11,12,40,45,50,51,52,53,60,61,62,63,64,65,68,69,80,81,82,83,90];
            $arrlevel = ['ปริญญาตรี ปกติ','ปริญญาตรี พิเศษ','ปริญญาโท ปกติ','ปริญญาโท พิเศษ','ปริญญาเอก ปกติ'];
        ...
        public function get_status_81($years) {
            //$arr = [10,11,12,40,45,50,51,52,53,60,61,62,63,64,65,68,69,80,81,82,83,90];
            $arrlevel = ['ปริญญาตรี ปกติ','ปริญญาตรี พิเศษ','ปริญญาโท ปกติ','ปริญญาโท พิเศษ','ปริญญาเอก ปกติ'];
        ...
        public function get_status_82($years) {
            //$arr = [10,11,12,40,45,50,51,52,53,60,61,62,63,64,65,68,69,80,81,82,83,90];
            $arrlevel = ['ปริญญาตรี ปกติ','ปริญญาตรี พิเศษ','ปริญญาโท ปกติ','ปริญญาโท พิเศษ','ปริญญาเอก ปกติ'];
        ...
        public function get_status_83($years) {
            //$arr = [10,11,12,40,45,50,51,52,53,60,61,62,63,64,65,68,69,80,81,82,83,90];
            $arrlevel = ['ปริญญาตรี ปกติ','ปริญญาตรี พิเศษ','ปริญญาโท ปกติ','ปริญญาโท พิเศษ','ปริญญาเอก ปกติ'];
        ...
        public function get_status_90($years) {
            //$arr = [10,11,12,40,45,50,51,52,53,60,61,62,63,64,65,68,69,80,81,82,83,90];
            $arrlevel = ['ปริญญาตรี ปกติ','ปริญญาตรี พิเศษ','ปริญญาโท ปกติ','ปริญญาโท พิเศษ','ปริญญาเอก ปกติ'];
        ...
        public function get_status_previous_2years() {

            $years = 2558;
            $years1 = $years-1;
            $arrstatus = [10,11,12,40,45,50,51,52,53,60,61,62,63,64,65,68,69,80,81,82,83,90];
            $arrlevel = ['ปริญญาตรี ปกติ','ปริญญาตรี พิเศษ','ปริญญาโท ปกติ','ปริญญาโท พิเศษ','ปริญญาเอก ปกติ'];
                    ...
                    FROM Student 
                    LEFT JOIN Status ON Student.Status_ID = Status.Status_ID 
                    WHERE (Status.Status_ID= $arrstatus[0]) AND (Entry_Years = $years OR Entry_Years = $years1) AND Level = '".$arrlevel[0]."'
                    GROUP BY Status_Name,Level";
                    $query = $this->db->query($sql);
                    if ($query->num_rows() ==0) {
        ...
        /*public function get_status($years) {
            $arrstatus = [10,11,12,40,45,50,51,52,53,60,61,62,63,64,65,68,69,80,81,82,83,90];
            $arrlevel = ['ปริญญาตรี ปกติ','ปริญญาตรี พิเศษ','ปริญญาโท ปกติ','ปริญญาโท พิเศษ','ปริญญาเอก ปกติ'];
            
            for($i = 0;$i<count($arrstatus);$i++) {
                for($j = 0;$j<count($arrlevel);$j++) {
                //$wherestatus = " Status.Status_ID='".$arr[$i]."'";
                $wherelevel = " Level='".$arrlevel[$j]."'";
                $wherestatus = " Status.Status_ID='".$arrstatus[$i]."'";
            $sql = "SELECT Status.Status_ID,Status.Status_Name, Level, count(*) AS Count 
            FROM Student 
            LEFT JOIN Status ON Student.Status_ID = Status.Status_ID 
            WHERE $wherestatus AND Entry_Years = '".$years."' AND $wherelevel
            GROUP BY Status_Name,Level";
            
            $query = $this->db->query($sql);
            $q[] = $query->result_array()[$i][$j];
